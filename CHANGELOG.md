...
- The clipboard history 屏幕取词 filter now shows text captured by screen text
  recognition instead of repeating the 文本 chip. Older history is only partly
  reclassified, so some earlier screen-text entries stay under 文本.
